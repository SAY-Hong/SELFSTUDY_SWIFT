...
//        switch color {
//            case .blue(let r, let g, let b) where b == 255 && r == 0 && g == 0:
//                print("이 색상은 파랑이고 RGB 값은 (0, 0, 255)입니다.")
//            case .red(let r, let g, let b) where r == 255 && g == 0 && b == 0:
//                print("이 색상은 빨강이고 RGB 값은 (255, 0, 0)입니다.")
//            case .green(let r, let g, let b) where g == 255 && r == 0 && b == 0:
//                print("이 색상은 초록이고 RGB 값은 (0, 255, 0)입니다.")
//        default: print("맞는 RGB 수치가 아닙니다!")
//        }
//    }
//}
//
//let colors = [Color.red(r: 255, g: 0, b: 0), Color.green(r: 0, g: 255, b: 0), Color.blue(r: 0, g: 0, b: 255), Color.blue(r: 10, g: 20, b: 255)]
